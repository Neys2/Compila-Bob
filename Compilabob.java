...
void errorDOBLElinea():{
  ...
  void error_gramaticoPP(int kind, ParseException ex) throws ParseException {
        Token t;
        String cadena = ex.toString();
        System.out.println("Error sint\u00e1ctico en el programa principal"+cadena);
